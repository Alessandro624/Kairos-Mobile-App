...
class UsersApi(basePath: kotlin.String = "http://10.0.2.2:8080") : ApiClient(basePath) {
     ...
     * @return void
     */
    fun changePassword(body: UserPasswordUpdateDTO): Unit {
     ...
     * @return void
     */
    fun deleteUser(userId: kotlin.Any): Unit {
        val localVariableConfig = RequestConfig(
    ...
    fun getAllUsers(page: kotlin.Any? = null, size: kotlin.Any? = null, sortBy: kotlin.Any? = null, direction: kotlin.Any? = null): Page {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun getAllUsersAdmin(page: kotlin.Any? = null, size: kotlin.Any? = null, sortBy: kotlin.Any? = null, direction: kotlin.Any? = null): Page {
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>().apply {
            if (page != null) {
                put("page", listOf(page.toString()))
            }
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun makeUserAdmin(userId: kotlin.Any): UserDTO {
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun makeUserOrganizer(userId: kotlin.Any): UserDTO {
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun updateUser(body: UserUpdateDTO, userId: kotlin.Any): UserDTO {
        val localVariableBody: kotlin.Any? = body
        val localVariableConfig = RequestConfig(
                RequestMethod.PUT,
                "/v1/users/{userId}".replace("{" + "userId" + "}", "$userId")
